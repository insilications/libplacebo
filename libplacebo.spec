...
Version  : 3.120.2
Release  : 15
URL      : https://github.com/haasn/libplacebo/archive/v3.120.2/libplacebo-3.120.2.tar.gz
Source0  : https://github.com/haasn/libplacebo/archive/v3.120.2/libplacebo-3.120.2.tar.gz
...
%prep
%setup -q -n libplacebo-3.120.2
cd %{_builddir}/libplacebo-3.120.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619219345
...
cp %{_builddir}/libplacebo-3.120.2/LICENSE %{buildroot}/usr/share/package-licenses/libplacebo/7fab4cd4eb7f499d60fe183607f046484acd6e2d
cp %{_builddir}/libplacebo-3.120.2/demos/LICENSE %{buildroot}/usr/share/package-licenses/libplacebo/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
