...
Version  : 3.120.1
Release  : 14
URL      : https://github.com/haasn/libplacebo/archive/v3.120.1/libplacebo-3.120.1.tar.gz
Source0  : https://github.com/haasn/libplacebo/archive/v3.120.1/libplacebo-3.120.1.tar.gz
...
%prep
%setup -q -n libplacebo-3.120.1
cd %{_builddir}/libplacebo-3.120.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617733977
...
cp %{_builddir}/libplacebo-3.120.1/LICENSE %{buildroot}/usr/share/package-licenses/libplacebo/7fab4cd4eb7f499d60fe183607f046484acd6e2d
cp %{_builddir}/libplacebo-3.120.1/demos/LICENSE %{buildroot}/usr/share/package-licenses/libplacebo/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
