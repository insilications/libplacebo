...
Patch1: 0001-spirv-glslang-fix-compatibility-with-glslang-8.13.37.patch
...
%prep
%setup -q -n libplacebo-2.72.0
cd %{_builddir}/libplacebo-2.72.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
cp %{_builddir}/libplacebo-2.72.0/LICENSE %{buildroot}/usr/share/package-licenses/libplacebo/369e12e20fe82ad69eb9b0e51fa98aa5f507d7e4
